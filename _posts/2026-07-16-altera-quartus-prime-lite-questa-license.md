...
> La dernière version utilisable **gratuitement** pour la simulation avec *Questa FPGA Starter Edition* reste *Quartus Prime Lite 2024.1*, publiée juste avant la transition vers Altera.
{: .prompt-warning }
